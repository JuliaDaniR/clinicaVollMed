...
public class ConfiguracionHorariaController {
    ...
    public ResponseEntity<?> crear(@RequestBody @Valid ConfiguracionHorariaDTO dto,
        ...
        try {
            ...
            return ResponseEntity.created(uri).body(Map.of(
                    ...
                    "medico", config.getMedico().getNombre(),
    ...
    public ResponseEntity<?> actualizar(
        ...
        try {
            ...
            int turnosRegenerados = agendaService.regenerarDesdeHoy(config.getMedico());
...
// ============================================================
    ...
    public ResponseEntity<?> regenerar(@PathVariable Long id) {
        ...
        try {
            ...
            int generados = agendaService.regenerarDesdeHoy(config.getMedico());
    ...
    public ResponseEntity<?> regenerarDia(
        ...
        try {
            ...
            int generados = agendaService.regenerarDia(config.getMedico(), fecha);
    ...
    public ResponseEntity<?> regenerarRango(
        ...
        try {
            ...
            int generados = agendaService.regenerarRango(config.getMedico(), inicio, fin);
