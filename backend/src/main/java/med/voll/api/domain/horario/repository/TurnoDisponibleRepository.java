...
public interface TurnoDisponibleRepository extends JpaRepository<TurnoDisponible, Long> {
    ...
    Optional<TurnoDisponible> findByMedicoIdAndFechaAndHora(Long medicoId, LocalDate fecha, LocalTime hora);
    ...
    List<TurnoDisponible> findByMedicoIdAndEstadoAndFechaGreaterThanEqualOrderByFechaAscHoraAsc(Long medicoId, EstadoTurno estado, LocalDate fecha);
